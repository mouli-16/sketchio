...
const PlayerInput = () => {
  ...
  return (
    <div className="landingContainer">
      <div className="alert">
        {error ? (
          <Alert severity="error">An Error Occured: {error}</Alert>
        ) : checked ? (
          <Alert severity="success">You Entered a Valid Room Code!!!</Alert>
        ) : created ? (
          <Alert severity="success">Room Created !!!</Alert>
        ) : null}
      </div>
        ...
        <div className="inputLeft">
          <div className="top">
            ...
            <input
              ...
              onKeyPress={(event) =>
                event.key === "Enter" ? checkRoom() : null
              }
            />
            <div className="butn">
              {checked ? (
          ...
          <div className="bottom">
            <input
              ...
              onChange={(e) => setName(e.target.value)}
              onKeyPress={(event) =>
                event.key === "Enter" ? createRoom() : null
              }
            />
            <div className="butn">
              {created ? (
